...
2. Hover: Triggered when the user moves the pointer over the dropdown field. Visual cue (e.g., subtle
...
4. Filled (closed menu): Occurs after the user selects an option. Selected value replaces placeholder text.

Field returns to default or focus styling, depending on interaction.
